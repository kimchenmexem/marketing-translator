...
const ES: LocaleBundle = {
  tm: [
    ...
    {
      source: "Pioneering the path towards transparent, low-cost trading.",
      targets: ["Pioneros en el camino hacia una negociación transparente y de bajo coste."],
    },
    { source: "Trade ETFs with 0 commissions", targets: ["Negocie ETFs sin comisiones"] },
    {
      source: "Enjoy the flexibility of fractional trading on most EU & US stocks.",
      targets: ["Disfrute de la flexibilidad de invertir en acciones fraccionadas en la mayoría de acciones de la UE y EE. UU."],
    },
    {
      source: "Caution. Investing involves risk of loss. Third party fees and Terms & conditions apply*.",
      targets: ["Precaución. Invertir implica riesgo de pérdida. Se aplican tarifas de terceros y términos y condiciones*."],
    },
    { source: "Global Investing", targets: ["Inversión Global"] },
    {
      source: "Trade across 170 markets in 40 countries and 29 currencies.",
      targets: ["Negocie en 170 mercados de 40 países y en 29 divisas."],
    },
    { source: "Fractional Shares", targets: ["Acciones Fraccionadas"] },
    { source: "Choose your account type", targets: ["Elija su tipo de cuenta"] },
    {
      source: "Individual, joint, corporate, advisor, junior and more!",
    ...
    {
      source: "Receive support in 10+ languages tailored to your needs.",
      targets: ["Reciba asistencia en más de 10 idiomas adaptada a sus necesidades."],
    },
    { source: "Investing Savings plan", targets: ["Plan de Ahorro de Inversión"] },
    {
      source: "Choose your assets and set your own schedule, keeping your investments consistent over-time",
      targets: ["Elija sus activos y establezca su propio calendario, manteniendo sus inversiones consistentes a lo largo del tiempo."],
    },
    { source: "Low Trading Fees", targets: ["Tarifas de Negociación Bajas"] },
    { source: "Access Global Financial Markets", targets: ["Acceda a los Mercados Financieros Globales"] },
    {
      source: "We offer you a gateway to worldwide trading, granting access to a wide range of markets, countries and currencies.",
      targets: ["Le ofrecemos una puerta de entrada al trading internacional, brindándole acceso a una amplia gama de Mercados, Países y Divisas."],
    },
    ...
    { source: "EXPLORE OUR PRODUCTS", targets: ["DESCUBRA NUESTROS PRODUCTOS"] },
    {
      source: "Trade global stocks, options, futures, bonds, ETFs and more from one integrated account.",
      targets: ["Negocie acciones globales, opciones, futuros, bonos, ETFs y más desde una única cuenta integrada."],
    },
    {
      source: "*Trading complex products such as options, futures and warrants carries a high level of risk and may not be suitable for all investors.",
      targets: ["*La negociación de productos complejos como opciones, futuros y warrants conlleva un alto nivel de riesgo y puede no ser adecuada para todos los inversores."],
    },
    { source: "All Products", targets: ["Todos los Productos"] },
    { source: "PUT YOUR BUSINESS CAPITAL WORK", targets: ["PONGA A TRABAJAR SU CAPITAL EMPRESARIAL"] },
    {
      source: "Your business is making profits, but how you manage them is equally important. A corporate investment account offers a structured, tax-efficient way to allocate capital, while keeping access to global opportunities.",
      targets: ["Su empresa genera beneficios, pero gestionarlos de forma eficiente es igual de importante. Una cuenta de inversión corporativa ofrece una forma estructurada y fiscalmente eficiente de asignar capital, manteniendo al mismo tiempo el acceso a oportunidades globales."],
    },
    { source: "Explore Corporate Accounts", targets: ["Explore Cuentas Corporativas"] },
  ],
  glossary: [
  ...
  forbidden: [
    { phrase: "Bajas Tarifas de Negociación", reason: "Reviewer rejected — Spanish requires noun+adjective ('Tarifas de Negociación Bajas')." },
    { phrase: "HAGA TRABAJAR SU CAPITAL EMPRESARIAL", reason: "Reviewer rejected — use 'PONGA A TRABAJAR SU CAPITAL EMPRESARIAL'." },
    { phrase: "Haga trabajar su capital empresarial", reason: "Reviewer rejected — use 'Ponga a trabajar su capital empresarial'." },
    { phrase: "la gestión de estos", reason: "Reviewer rejected — too stiff; rephrase as 'gestionarlos de forma eficiente'." },
    { phrase: "negociación fraccionada", reason: "Use 'invertir en acciones fraccionadas' in the fractional-shares sentence." },
