...
const RULES: Record<LocaleCode, JurisdictionRules> = {
  ...
  "de-DE": {
    ...
    language: "German",
    prohibited: [
      "Guaranteed returns: 'garantierte Renditen', 'sicherer Gewinn', 'garantiertes Einkommen'",
      "Risk-free claims: 'risikofrei', 'ohne Risiko', 'sichere Anlage', 'geschütztes Kapital'",
      "Urgency tactics: 'begrenztes Angebot', 'jetzt handeln', 'letzte Chance'",
      "Unsupported superlatives: 'der beste', 'Marktführer', 'Nummer eins'",
      "Wealth outcome promises: 'werden Sie Millionär', 'reich werden', 'finanzielle Freiheit'",
      "Investment advice: 'Sie sollten investieren', 'jetzt ist der richtige Zeitpunkt zu investieren'",
      "Comparative advertising without substantiated data",
    ],
    conditionalRequirements: [
      "If mentioning returns or performance: must immediately balance with capital-loss risk warning",
      "If referencing past performance: must state 'Die frühere Wertentwicklung ist kein verlässlicher Indikator für die künftige Wertentwicklung'",
      "Must not present the product as suitable for all investors without qualification",
      "Every benefit claim must be accompanied by a corresponding risk disclosure (MiFID II Art. 24(3))",
    ],
    compliantFeatures: [
      "'Provisionsfrei', 'keine Provisionen', '0 € Provision' — pricing model, NOT investment return",
      "'Transparente Preisgestaltung', 'klare Gebühren' — fee transparency feature",
      "'Professionelle Plattform', 'fortschrittliche Tools' — platform capability",
      "'Über 70 ETP', 'Zugang zu den globalen Märkten' — product catalogue",
    ],
    riskWarning: "Investitionen sind mit Risiken verbunden, einschließlich des teilweisen oder vollständigen Verlusts des eingesetzten Kapitals.",
    pastPerformanceDisclaimer: "Die frühere Wertentwicklung ist kein verlässlicher Indikator für die künftige Wertentwicklung.",
    regulatorNotes: "BaFin (Bundesanstalt für Finanzdienstleistungsaufsicht) is the German regulator; MiFID II / ESMA rules apply as Germany is an EU member. Communications must be fair, clear and not misleading (klar, redlich und nicht irreführend), with risks given equivalent prominence to benefits.",
  },
  "it-IT": {
    locale: "it-IT",
